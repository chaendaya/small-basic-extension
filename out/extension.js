...
let candidatesData;
let sbSnippetGenerator = null; // What's changed
let linePrefix;
let resulted_prefix;
let candidate_list = [];
// -- ChatGPT API Code --
...
function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand("extension.completeCode", async () => {
        ...
        const untitledUri = vscode.Uri.parse("untitled:" + path.join("SuggestedCode.sb")); // Generate a URI for an untitled document that will display the code
